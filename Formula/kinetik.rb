class Kinetik < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/xiaoanne/homebrew-d3/releases/download/v1.0.0/kinetik--0.13.5.arm64_monterey.bottle.tar.gz"
    sha256 "04f71a4e4f736d7247a934740e91a199111c52522ce5c12854e688edfa154296"
  else
    url "https://github.com/xiaoanne/homebrew-d3/releases/download/v1.0.0/kinetik--0.13.5.x86_64_monterey.bottle.tar.gz"
